...
const PortfolioPage: React.FC = () => {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      description: 'Full-stack web app for HKN UCSD engineering honor society with Django authentication system, PostgreSQL database, event management, resource library, and member dashboard with permissions system',
      imageUrl: '',
      category: 'software',
      featured: false,
      technologies: [techList.react, techList.django, techList.javascript, techList.postgresql, techList.sql],
      // projectUrl: '/projects/hkn-portal',
      projectUrl: 'https://portal.hknucsd.com/',
    },
    {
      id: 3,
      title: 'LingoLab Research Paper Analyzer',
      description: 'Award-winning PDF research paper analyzer that leverages LLMs to extract challenging terminology with type/format validation and field relationship mapping. Built with a microservices architecture (Node.js, Python FastAPI, NoSQL storage) that earned "Most Technically Impressive" and 3rd place at a competitive 1-day hackathon. Led architecture design, backend integration, and database schema development.',
      imageUrl: '',
      category: 'machine-learning',
      featured: false,
      technologies: [techList.react, techList.python, techList.firebase, techList.typescript, techList.nodejs, techList.express, techList.llm],
    ...
    },
    {
      id: 5,
      title: 'Aako.world',
      description: 'Developed a landing site for a geo-bound mp3 sharing social media platform startup, implementing client designs and conducting structured communication about requirements',
      imageUrl: '',
      category: 'software',
      featured: false,
      technologies: [techList.react, techList.javascript, techList.typescript],
      projectUrl: 'https://aako.world',
    },
    {
      id: 6,
      title: 'CSES Main Website',
      description: 'Developed the official website for Computer Science and Engineering Society at UCSD featuring event calendars, resources, and member services',
      imageUrl: '',
      category: 'software',
      featured: false,
      technologies: [techList.react, techList.javascript, techList.nodejs],
      projectUrl: 'https://cses.ucsd.edu',
    },
    {
      id: 7,
      title: 'CSES Open Source Branch Website',
      description: 'Built the platform for CSES open source branch, showcasing projects and facilitating student contributions to the open source community',
      imageUrl: '',
      category: 'software',
      featured: false,
      technologies: [techList.react, techList.javascript, techList.nodejs],
    ...
    {
      id: 8,
      title: 'Harmful Algae Bloom Prediction App',
      description: 'Containerized a ML prediction app with Docker and deployed to GCP, providing timely alerts for harmful algae blooms',
      imageUrl: '',
      category: 'machine-learning',
      featured: false,
